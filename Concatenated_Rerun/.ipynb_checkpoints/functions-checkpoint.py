...
#    data_binary = np.array([[int(d) for i in j for d in str('{0:016b}'.format(i))] for j in list(data)],dtype=object)
#    return data_binary    
def convert_to_binary(data,bit_size=16):
...
def Tokenize_and_Binarize(dataset,file_name,tok_save_path,np_save_path,data_len,look_back,test_ratio):
    '''
